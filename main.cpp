...
private:
	...
	// допустимые значени€ сохраним в static переменных
	// они объ€влены inline, чтобы их определение не надо было выносить вне класса
	...
	// постфикс s у литерала тут недопустим, он приведЄт к неопределЄнному поведению
